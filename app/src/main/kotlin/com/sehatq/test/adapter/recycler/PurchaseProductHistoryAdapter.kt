...
class PurchaseProductHistoryAdapter : DataListRecyclerViewAdapter<ProductPromo, PurchaseProductHistoryAdapter.ViewHolder>() {

    var onPurchaseProductClick: OnPurchaseProductClick? = null
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindView() {
            ...
            itemView.setOnClickListener { onPurchaseProductClick?.invoke(data, adapterPosition) }
        }
    }
}

typealias OnPurchaseProductClick = ((data: ProductPromo, position: Int) -> Unit)
